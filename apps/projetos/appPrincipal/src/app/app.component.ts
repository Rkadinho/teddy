...
import { MenuHorizontalComponent } from 'apps/projetos/menus/src/app/menu-horizontal/menu-horizontal.component';
import { MenuVerticalComponent } from 'apps/projetos/menus/src/app/menu-vertical/menu-vertical.component';
